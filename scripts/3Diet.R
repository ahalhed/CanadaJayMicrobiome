...
print("all samples")
yes <- plot3 %>% filter(FoodSupplement == "Y") %>% select(n)
no <- plot3 %>% filter(FoodSupplement == "N") %>% select(n)
var.test(yes$n, no$n)
...
rm(yes, no)
print("2017 only")
yes <- plot3 %>% filter(FoodSupplement == "Y", CollectionYear == 2017) %>% select(n)
no <- plot3 %>% filter(FoodSupplement == "N", CollectionYear == 2017) %>% select(n)
var.test(yes$n, no$n)
t.test(yes, no, alternative = "less")
rm(yes, no)
print("2018 only")
yes <- plot3 %>% filter(FoodSupplement == "Y", CollectionYear == 2018) %>% select(n)
no <- plot3 %>% filter(FoodSupplement == "N", CollectionYear == 2018) %>% select(n)
var.test(yes$n, no$n)
t.test(yes, no, alternative = "less")
rm(yes, no, plot3)
