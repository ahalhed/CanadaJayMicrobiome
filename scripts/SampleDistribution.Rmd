...
ps <- qza_to_phyloseq(metadata = "input/jay-met.tsv",
                features = "filtered-table-no-singletons-mitochondria-chloroplast.qza")
```

```{r}
(or <- ordinate(ps, method = "RDA", formula = . ~ CollectionYear))
anova(or)
```
