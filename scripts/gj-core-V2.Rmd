...
# select otus occurring in 100% of samples at a site and/or in the highest ranked
...
```{r}
setwd("~/OneDrive - University of Guelph/Alicia's Thesis/GreyJayMicrobiome")
pdf("CanadaJayMicrobiome/plots/coreSites.pdf")
ggplot(filteredDF,aes(x=Territory, fill=otu, y=plot_freq)) +
  geom_bar(stat = 'identity', position = 'dodge') +
  coord_flip() + scale_fill_viridis_d() +
  labs(x='Canada Jay Territory in Algonquin Provincial Park',
       y='Occupancy by site')
dev.off()
```
